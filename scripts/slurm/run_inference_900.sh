#!/bin/bash
#SBATCH --job-name=inference_900
#SBATCH --partition=gpu
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=30:00:00
#SBATCH --output=/n/home07/sangwonjung/ProDifEvo-Refinement/datasets/laproteina_900/inference_%j.log
...
echo "=========================================="
echo "STEP 1: Extract sequences from 900 PDBs"
echo "=========================================="
echo "Start: $(date)"
