#!/bin/bash
#SBATCH --job-name=laproteina_7000more
#SBATCH --partition=seas_gpu
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --time=04:00:00
#SBATCH --output=/n/holylabs/LABS/calmon_lab/Lab/datasets/sangwonjung/laproteina_1000/generation_7000more_%j.log
...
echo "=========================================="
echo "La Proteina: Generate 7000 more samples"
echo "Start time: $(date)"
echo "=========================================="

# Run generation
$PYTHON proteinfoundation/generate.py --config_name inference_7000samples
...
gen_dir = os.path.join(LAPROTEINA_DIR, 'inference/inference_7000samples')
...
# Starting index: batch1(100) + batch2(900) + batch3(2000) = 3000
start_idx = 3000
...
print(f"\nAdded {len(new_sequences)} new samples (batch4)")
